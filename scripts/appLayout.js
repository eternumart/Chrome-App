export const popupLayout = `<div class="mji-manager-app">
	<div class="header">
...
export const stylesLayout = `<style>
	.mji-manager-app * {
		padding: 0;
		margin: 0;
...
export const fakeSelectButton = `<div class="fakeSelect__selector">
...
export const fakeSelectList = `<ul class="fakeSelect">
