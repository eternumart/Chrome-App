...
function launchApp(login, loginIsPossible, launchStatus) {
	...
	function loadData() {
		...
		clickGenerator(appVariables.krovlyaOcenka, loadData["Результаты выборочного обследования"]["Крыша"][appVariables.krovlaName]["Оценка"], true);
	...
	function createFakeSelects() {
		...
		const selectsValues = {
			...
			ХВС: {
				...
				"Внутренний пожарный водопровод": {
					conditions: {
						Безусловно: ["Незаполненность системы водой.", "Коррозия, свищи и хомуты на трубопроводах.", "Разукомплектованность или отсутствие рукавов, стволов.", "Недействующие повысительные насосы.", "Коррозия трубопроводов, соединений, арматуры."],
					},
					conditionNode: false,
				},
			},
